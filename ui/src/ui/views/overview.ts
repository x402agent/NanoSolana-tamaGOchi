...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">nanosolana devices list</span><br />
          <span class="mono">nanosolana devices approve &lt;requestId&gt;</span>
        </div>
  ...
  const authHint = (() => {
    ...
    if (shouldShowAuthRequiredHint(hasToken, hasPassword, props.lastErrorCode)) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">nanosolana dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">nanosolana doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "nanosolana dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.nanosolana.com/web/dashboard"
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px;">
                    <input
                      ...
                      placeholder="NANO_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
            ...
            ? html`
                <div class="login-gate__help" style="margin-top: 16px;">
                  ...
                  <ol class="login-gate__steps">
                    ...
                    <li>${t("overview.connection.step4")}<code>nanosolana doctor --generate-gateway-token</code></li>
                  </ol>
