...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.nanosolana/nanosolana.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde nano dashboard --no-open en tu escritorio.",
    },
    insecure: {
