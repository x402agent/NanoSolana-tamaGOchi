...
func (c *Client) FutBalance() ([]FuturesBalance, error) {
	data, err := c.futSignedGet("/fapi/v2/balance", url.Values{})
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutAccount() (*FuturesAccount, error) {
	data, err := c.futSignedGet("/fapi/v4/account", url.Values{})
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutPositionRisk(symbol string) ([]PositionRisk, error) {
	...
	data, err := c.futSignedGet("/fapi/v2/positionRisk", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutNewOrder(p NewOrderParams) (*OrderResponse, error) {
	...
	data, err := c.futSignedPost("/fapi/v1/order", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutCancelOrder(symbol string, orderID int64, clientOrderID string) (*OrderResponse, error) {
	...
	data, err := c.futSignedDelete("/fapi/v1/order", params)
	if err != nil {
		return nil, err
	}
	var order OrderResponse
...
func (c *Client) FutCancelAllOrders(symbol string) error {
	params := url.Values{"symbol": {symbol}}
	_, err := c.futSignedDelete("/fapi/v1/allOpenOrders", params)
	return err
}
...
func (c *Client) FutQueryOrder(symbol string, orderID int64, clientOrderID string) (*OrderResponse, error) {
	...
	data, err := c.futSignedGet("/fapi/v1/order", params)
	if err != nil {
		return nil, err
	}
	var order OrderResponse
...
func (c *Client) FutOpenOrders(symbol string) ([]OrderResponse, error) {
	...
	data, err := c.futSignedGet("/fapi/v1/openOrders", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutAllOrders(symbol string, limit int) ([]OrderResponse, error) {
	...
	data, err := c.futSignedGet("/fapi/v1/allOrders", params)
	if err != nil {
		return nil, err
	}
	var orders []OrderResponse
...
func (c *Client) FutUserTrades(symbol string, limit int) ([]TradeRecord, error) {
	...
	data, err := c.futSignedGet("/fapi/v1/userTrades", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutIncome(symbol, incomeType string, limit int) ([]IncomeRecord, error) {
	...
	data, err := c.futSignedGet("/fapi/v1/income", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutChangeLeverage(symbol string, leverage int) (*LeverageResponse, error) {
	...
	data, err := c.futSignedPost("/fapi/v1/leverage", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutChangeMarginType(symbol string, marginType MarginType) error {
	...
	_, err := c.futSignedPost("/fapi/v1/marginType", params)
	return err
}
...
func (c *Client) FutModifyPositionMargin(symbol string, amount string, marginChangeType int) error {
	...
	_, err := c.futSignedPost("/fapi/v1/positionMargin", params)
	return err
}
...
func (c *Client) FutLeverageBrackets(symbol string) ([]LeverageBracket, error) {
	...
	data, err := c.futSignedGet("/fapi/v1/leverageBracket", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) FutGetPositionMode() (bool, error) {
	data, err := c.futSignedGet("/fapi/v1/positionSide/dual", url.Values{})
	if err != nil {
		return false, err
	}
	var resp struct {
...
func (c *Client) FutSetPositionMode(hedgeMode bool) error {
	...
	_, err := c.futSignedPost("/fapi/v1/positionSide/dual", params)
	return err
}
...
func (c *Client) Transfer(asset string, amount string, kindType string, clientTranID string) (*TransferResponse, error) {
	...
	data, err := c.futSignedPost("/fapi/v1/asset/wallet/transfer", params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) SpotNewOrder(p NewOrderParams) (*OrderResponse, error) {
	...
	data, err := c.spotSignedPost("/api/v1/order", params)
	if err != nil {
		return nil, err
	}
	var order OrderResponse
...
func (c *Client) SpotAccount() (*FuturesAccount, error) {
	data, err := c.spotSignedGet("/api/v1/account", url.Values{})
	if err != nil {
		return nil, err
	}
	var account FuturesAccount
...
func (c *Client) FutBatchOrders(orders []NewOrderParams) ([]json.RawMessage, error) {
	...
	data, err := c.futSignedPost("/fapi/v1/batchOrders", params)
	if err != nil {
		return nil, err
	}
