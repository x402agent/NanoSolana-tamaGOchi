...
func Debug(msg string) { logf(DEBUG, "mawdbot", msg, nil) }
func Info(msg string)  { logf(INFO, "mawdbot", msg, nil) }
func Warn(msg string)  { logf(WARN, "mawdbot", msg, nil) }
func Error(msg string) { logf(ERROR, "mawdbot", msg, nil) }
