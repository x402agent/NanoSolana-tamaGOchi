// Package research provides the autonomous experiment loop for MawdBot.
...
import (
	...
	"github.com/8bitlabs/mawdbot/pkg/logger"
	"github.com/8bitlabs/mawdbot/pkg/memory"
)
...
func (rl *ResearchLoop) updateStrategy(result ExperimentResult) {
	...
	content := fmt.Sprintf(`# MawdBot Strategy
