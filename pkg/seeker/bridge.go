// Package seeker provides the NanoSolana agent for the Solana Seeker phone.
//
// Replaces the Node.js + OpenClaw stack from SeekerClaw with a native Go
// binary running the full NanoSolana OODA trading loop + Telegram bot.
//
// Architecture:
//
...
//	         ├─ NanoSolana gateway (TCP + Tailscale)
...
// the SeekerClaw/NanoSolana Android app foreground service.
...
func WritePlatformInfo(ctx context.Context, cfg SeekerConfig, bridge *BridgeClient) error {
	content := fmt.Sprintf(`# PLATFORM.md — Device State

> Auto-generated by NanoSolana Seeker on startup.

## Runtime
- **Agent**: NanoSolana v2.0.0 (Go ARM64)
- **Binary**: ~10MB
- **Boot time**: <1s
