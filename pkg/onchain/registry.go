...
var (
	...
	// NanoSolana Registry Collection (devnet)
...
// AgentMetadata is the on-chain representation of a NanoSolana agent.
...
func RegisterAgent(
	...
	metadata := AgentMetadata{
		Name:         fmt.Sprintf("NanoSolana Agent #%s", agentPubkey.String()[:6]),
		Symbol:       "NANO",
		Description:  fmt.Sprintf("NanoSolana autonomous trading agent. Version %s. Fingerprint: %s", version, fingerprint[:12]),
		Image:        "https://go.nanosolana.com/agent-nft.png",
