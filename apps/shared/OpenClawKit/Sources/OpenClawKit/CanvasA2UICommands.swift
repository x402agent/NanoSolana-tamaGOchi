...
public enum NanoSolanaCanvasA2UICommand: String, Codable, Sendable {
...
public struct NanoSolanaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NanoSolanaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
