...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.nanosolana", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("NanoSolana/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__nanosolana__/a2ui/").absoluteString + "?platform=macos"
    }
