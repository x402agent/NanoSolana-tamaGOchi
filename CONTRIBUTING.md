# 🤝 Contributing to MawdBot Go

Thanks for your interest in contributing to MawdBot! Here's how to get started.
...
./build/mawdbot ooda --sim --interval 60
...
└── .gitignore             # Excludes .env, build/, vendor/
```
...
- **Logging**: use `log.Printf("[COMPONENT] message")` with emoji prefixes
...
- **TamaGOchi features** — new moods, animations, or evolution stages
