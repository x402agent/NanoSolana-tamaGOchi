...
describe('skill OG SVG', () => {
  it('includes title, description, and labels', () => {
    const svg = buildSkillOgSvg({
      ...
      ownerLabel: '@jhillock',
      versionLabel: 'v1.2.3',
      footer: 'hub.nanosolana.com/jhillock/discord-doctor',
    })
    ...
    expect(svg).toContain('hub.nanosolana.com/jhillock/discord-doctor')
  })
  ...
  it('wraps long titles to avoid clipping', () => {
    const svg = buildSkillOgSvg({
      ...
      versionLabel: 'v1.0.2',
      footer: 'hub.nanosolana.com/swiftlysisngh/excalidraw-flowchart',
    })
  ...
  it('clips and wraps long descriptions', () => {
    ...
    const svg = buildSkillOgSvg({
      ...
      ownerLabel: '@pasogott',
      versionLabel: 'v0.1.0',
      footer: 'hub.nanosolana.com/pasogott/gurkerlcli',
    })
