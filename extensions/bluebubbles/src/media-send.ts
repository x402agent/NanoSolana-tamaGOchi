...
import { resolveChannelMediaMaxBytes, type NanoSolanaConfig } from "nanosolana/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: NanoSolanaConfig; accountId?: string }): string[] {
