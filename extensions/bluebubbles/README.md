...
This directory contains the **BlueBubbles external channel plugin** for NanoSolana.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `nanosolana/plugin-sdk` helpers.
