...
import { isSecretRef } from "nanosolana/plugin-sdk/googlechat";
import { createAccountListHelpers, type NanoSolanaConfig } from "nanosolana/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: NanoSolanaConfig): ResolvedGoogleChatAccount[] {
