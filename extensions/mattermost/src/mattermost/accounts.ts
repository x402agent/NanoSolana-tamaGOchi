...
import { createAccountListHelpers, type NanoSolanaConfig } from "nanosolana/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: NanoSolanaConfig): ResolvedMattermostAccount[] {
