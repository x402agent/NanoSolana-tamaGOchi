...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("nanosolana/plugin-sdk/mattermost").NanoSolanaConfig;
    runtime: import("nanosolana/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: NanoSolanaPluginApi) {
